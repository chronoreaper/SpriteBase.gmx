...
switch floor(arg_wep){
    case 2:total=75; break;//dagger
    case 7:total=85-(arg_dis-1)*3;break;//bow
    case 8:total=85; break;//sword
    case 9:total=65; break;//club
    case 10:total=80; break;//stick
    case 50:total=95; break;//xcalabur
    default: total=75; break;//no wep
}
